*1 of 3 from [Azure Storage Account LAB](https://github.com/cyrilliams/theazureproject/blob/main/LABS/lab%20-%20azure%20storage%20account.md)

# Configure & Manage Azure Storage Accounts

In this doc, we'll configure and manage Storage Account, configure an Policy for immutability, and configure limited access.
